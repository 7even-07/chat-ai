...
export default function AddCharacter() {
  ...
  useEffect(() => {
    if (params.userId) {
        setMemberId(Number(params.userId))
    }
  }, [params?.userId])
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    ...
    if (result?.resonse_code) {
      router.push(`/user-account/${params.userId}/${params.username}/`);
    }
  }
      ...
      <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                />
                {voicePreview && 
                <audio src={voicePreview} className="mt-2 w-32 h-32 object-cover rounded"></audio>
                }
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select name="language" id="language" onChange={(e) => setLanguage(e.target.value)} className="w-full border rounded px-3 py-2">
          ...
          <div>
            ...
            <select name="gender" id="gender" onChange={(e) => setGender(e.target.value)} className="w-full border rounded px-3 py-2">
